          ...
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" className="w-full bg-light-bg border border-gray-200 rounded-xl px-4 py-3 text-slate-text font-medium focus:outline-none focus:border-electric-purple focus:ring-2 focus:ring-electric-purple/20 transition-all shadow-sm" placeholder="Gautma" />
              </div>
              <div>
