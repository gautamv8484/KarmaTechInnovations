        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <motion.div style={{ y: y1 }} className="aspect-square md:aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl relative">
              ...
              <img id='' src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80" alt="Team collaborating" className="w-full h-full object-cover opacity-90 transition-all duration-700 hover:scale-105" />
            </motion.div>
