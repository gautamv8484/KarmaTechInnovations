...
const EMAILJS_SERVICE_ID = 'import { useState, useRef } from 'react';
import emailjs from '@emailjs/browser';
    ...
    <section id="contact" className="py-24 relative overflow-hidden bg-light-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto mb-12">
          ...
          {/* WhatsApp */}
          <a
            href="https://wa.me/919876543210?text=Hi KARMA Tech! I visited your website and I'm interested in your services."
            target="_blank"
          ...
          >
            ...
            <span className="text-slate-muted text-xs mt-1">+91 98765 43210</span>
