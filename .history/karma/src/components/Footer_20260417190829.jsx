      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-gray-100 pb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">              <li className="text-slate-muted font-medium cursor-pointer hover:text-electric-purple">hello@karmatechinnovations.com</li>
              <li className="text-slate-muted font-medium cursor-pointer hover:text-electric-purple">+91 </li>
