      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <div className="flex-shrink-0 flex items-center gap-2">
            <Link to="/" className={`text-3xl font-display font-bold tracking-widest text-slate-text`}>
              KARMA<span className="text-electric-purple text-lg leading-none px-1">TECH INNOVATIONS</span> 
            </Link>
          </div>
          <div className="hidden md:flex space-x-8">
            <a href="/#hero" className="text-slate-muted hover:text-electric-purple font-medium transition-colors duration-200">Home</a>
